...
echo "  释义（tokken Anthropic 限流，无 launchd；禁止挂着秒级 --loop）:"
echo "    python3 $ROOT/scripts/jp-vocab-fill-meaning-api.py          # 补 1 条"
echo "    # --loop 仅人工盯着跑：有活 3min / 空闲 10min；跑完务必 Ctrl+C 停掉"
echo ""
echo "手动单阶段:"
