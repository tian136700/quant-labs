#!/usr/bin/env python3
"""Regression: sessionStart must inject phone/tablet UI adaptation reminder."""
...
HOOK = ROOT / ".cursor" / "hooks" / "mobile-responsive-session.py"
RULE = ROOT / ".cursor" / "rules" / "mobile-responsive-ui.mdc"
HOOK_CMD = ".cursor/hooks/mobile-responsive-session.py"
...
def main() -> None:
    ...
    for phrase in ("手机", "平板", "纯逻辑", "mobile.css"):
    ...
    print("OK: mobile-responsive sessionStart hook + rule present")
