...
CONJ_PAIR_SYSTEM = (
    ...
    "ない形示例：一类动词去掉「く」加「かない」＋かない｜如「書く→書かない」；二类动词去掉「る」加「ない」＋ない｜如「食べる→食べない」；三类动词「する」换成「しない」＋しない｜如「勉強する→勉強しない」；三类动词「くる」换成「こない」＋こない｜如「来る→来ない」。"
    "动词分类对照（❌禁止左边 → ✅必须写右边）：五段／五段动词／一類動詞 → 一类动词；一段／一段动词 → 二类动词；カ变／サ变／する・くる不规则 → 三类动词；❌禁止「一类动词（五段）」括注。"
    "变形写法对照：❌「う段改为あ段＋ない」／「将词尾变为…」散文 → ✅「一类动词去掉「く」加「かない」＋かない｜如「書く→書かない」」；❌接序下另写「例：」行 → ✅例子写在「｜」后说明列；说明内勿用「／」。"
)
