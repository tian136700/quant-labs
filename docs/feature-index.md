...
| **韩语发音复习**（重新开始 / 继续断点；熟悉/不熟悉；列表：熟悉 / 不熟悉 / 总复习 / **今日复习次数**（北京日归零）；乱序；防剧透） | `KoPronReviewPage`；`recordKoPronReviewDone`；catalog.`today_review_count`+`today_review_date`；`koPronCatalogTodayReviewCount` |
