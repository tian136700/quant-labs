...
export const enMessages: Messages = {
    ...
    adminWorker1102: {
      ...
      page: {
        title: "Worker 1102 monitor",
        subtitle:
          "Risk snapshot for Error 1102: notes size, today's shared list payload, slow/large/5xx aggregates on hot paths, plus related traffic. Cloudflare kills the isolate on real 1102 so that hit is not counted here—use this board to compare risk factors.",
        backToAdmin: "← Back to admin (visit logs)",
      },
      auth: {
        required: "Please sign in with an admin account.",
      ...
      panel: {
        ...
        riskWarn: "Watch",
        riskCritical: "High",
        shareDate: "Share date (Beijing calendar)",
        quotaDate: "Quota day",
        subjectsHeading: "JP / EN size snapshot",
        heaviestHeading: "Heaviest notes (image hint)",
        heavySignalsHeading: "Hot-path heavy signals (slow / large / 5xx)",
