...
export const enMessages: Messages = {
    ...
    adminD1Quota: {
      meta: {
        ...
        description:
          "Diagnose Cloudflare D1 daily row read/write limits (≠ Worker Error 1027).",
      },
      page: {
        title: "D1 quota monitor",
        subtitle:
          "For CF email “rows_read 75%”: use this page plus Worker traffic. Probe SELECT 1 + hot-path quota error capture; no exact usage API. Quota day = Beijing 08:00→next 08:00.",
        backToAdmin: "← Back to admin (visit logs)",
      },
      auth: {
        required: "Please sign in with an admin account.",
      ...
      panel: {
        heading: "D1 daily row quota",
        refresh: "Refresh",
        refreshing: "Refreshing…",
        dateLabel: "Quota day (from Beijing 08:00)",
        diagnoseHint:
          "This board tracks D1 rows_read / rows_written limits; Worker daily requests → traffic monitor. Common cause: Mac vocab fill list_missing idle scans every minute.",
        workerTrafficLink: "→ {title} (Error 1027)",
        worker1102Link: "→ {title} (per-request 1102)",
        copyReport: "Copy diagnostic report",
        copySuccess: "Copied",
        copyFailed: "Copy failed",
        reportTitle: "D1 quota diagnostic",
        loadFailed: "Failed to load D1 quota diagnostic.",
        ...
        probeStatus: "Probe",
        probeOk: "SELECT 1 OK",
        probeReadLimited: "Daily row read limit hit",
        probeWriteLimited: "Daily row write limit hit",
        probeError: "Probe error",
        readLimit: "Read quota errors",
        writeLimit: "Write quota errors",
        hitsUnit: "hits",
        perDay: "rows/day limit",
        signalsHeading: "Quota errors by route (this quota day)",
        signalsEmpty: "No quota errors yet (opening this page runs a light probe).",
        guardrailsHeading: "Implementation notes",
        guardrailId: "ID",
        guardrailOk: "OK",
        guardrailDetail: "Detail",
        route: "Route",
        signal: "Signal",
        hits: "Hits",
