...
export const zhMessages: Messages = {
    ...
    adminWorker1102: {
      ...
      page: {
        title: "1102 诊断看板",
        subtitle:
          "采集可能导致 Error 1102 的风险数据：备注体积、今日共享列表载荷、热路径慢/大/5xx 聚合，以及相关流量交叉。真正的 1102 由 Cloudflare 杀进程，本看板记不到那一次本身，但可对照风险与重信号。",
        backToAdmin: "← 返回后台管理（访问日志）",
      },
      auth: {
        required: "请使用管理员账号登录后查看。",
      ...
      panel: {
        ...
        refresh: "刷新",
        refreshing: "刷新中…",
        dateLabel: "配额日（重信号 / 流量交叉）",
        diagnoseHint:
          "Error 1102 = 单次请求 CPU/内存顶满（不是日请求 1027）。优先看「客户端现场样本」（失败 URL、Ray、耗时）与风险等级；硬刷新整页 1102 本页 JS 跑不到，软导航/API 或其它标签页可捕获。重信号：≥2s / ≥80KB / 5xx。",
        copyReport: "复制诊断报告",
        copySuccess: "复制成功",
        copyFailed: "复制失败",
        ...
        shareDate: "共享日（北京日历）",
        quotaDate: "配额日",
        subjectsHeading: "日语 / 英语体积快照",
        heaviestHeading: "备注体积 Top（含贴图提示）",
        heavySignalsHeading: "热路径重信号（慢 / 大 / 5xx）",
        ...
        emptyHeavy: "暂无备注正文（或均为空）。",
        emptySignals: "本配额日暂无慢/大/5xx 聚合（部署后对 shared / class-notes 热路径开始累计）。",
        emptyTraffic: "流量 Top 里暂无相关热路径。",
        clientAggHeading: "客户端事件合计（浏览器上报）",
        clientSamplesHeading: "客户端现场样本（含失败 URL / Ray / 耗时）",
        eventKind: "事件",
        pagePath: "当前页",
        failedUrl: "失败请求",
        httpStatus: "状态码",
        ...
        username: "用户",
        time: "时间",
        emptyClient: "暂无客户端上报（部署后：软导航/API 见到 1102 HTML，或今日单词页成功加载 page_ok）。",
      },
    },
    adminTrends: {
      meta: {
