...
export const zhMessages: Messages = {
    ...
    adminWorker1102: {
      ...
      page: {
        title: "1102 诊断看板",
        subtitle: "单次请求 CPU/内存顶满（≠ 日请求 1027）。优先客户端现场与 shared 载荷，备注只是次要对照。",
        backToAdmin: "← 返回后台管理（访问日志）",
      },
      auth: {
        required: "请使用管理员账号登录后查看。",
      ...
      panel: {
        ...
        guidePriority: "优先看",
        guidePriorityDetail: "客户端现场、整页冷启动、shared/列表载荷、热路径慢/大/5xx。",
        guideNotes: "备注",
        ...
        relatedTrafficHeading: "相关热路径今日流量",
        ...
        emptyHeavy: "暂无备注正文（英语常见；无备注≠不会 1102）。",
        emptySignals: "本配额日暂无慢/大/5xx 聚合（部署后对 shared 等热路径开始累计）。",
        emptyTraffic: "流量 Top 里暂无相关热路径。",
        clientAggHeading: "客户端事件合计",
        clientSamplesHeading: "客户端现场样本",
        eventKind: "事件",
        pagePath: "当前页",
        failedUrl: "失败请求",
        httpStatus: "状态码",
