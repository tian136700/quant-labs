...
规则（必须遵守）：
1. 只输出一行词性正文；用中文
2. 只能从这些里选：名词、动词、い形容词、な形容词、副词、助词、接続词、感叹词、数词、连体词、代词、接尾词、接头词、连语、专有名词
3. 多词性用斜杠「/」连接，例如：名词/副词
4. 问候/寒暄套话用「感叹词」或「连语」；国名用「专有名词」；不要自造「寒暄语」
5. 不要释义、不要例句、不要编号、不要 markdown、不要解释过程
6. 只输出词性正文`;
}
