 ...
 *  分类名对齐延世 / 首尔大 / 西江 / TOPIK 教材习惯（非严格语言学）。
 *  只种进 `ko_pron_catalog`（韩语发音勾选）；禁止直接种进抽问表 `ko_pron_letter`。
 *  归属固定：ㅑㅕㅛㅠ 属基本元音；ㅐㅔ 等属复合元音——勿按语言学重划。
 */
...
export const KO_PRON_SEED_LETTERS: KoPronSeedLetter[] = [
  ...
  // 基本元音 10（ㅏㅑㅓㅕㅗㅛㅜㅠㅡㅣ；ㅑㅕㅛㅠ 仍属基本元音，勿划入复合）
  { letter: "ㅏ", reading: "아 / a", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅑ", reading: "야 / ya", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅓ", reading: "어 / eo", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅕ", reading: "여 / yeo", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅗ", reading: "오 / o", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅛ", reading: "요 / yo", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅜ", reading: "우 / u", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅠ", reading: "유 / yu", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅡ", reading: "으 / eu", meaning: "基本元音", category: "基本元音" },
  { letter: "ㅣ", reading: "이 / i", meaning: "基本元音", category: "基本元音" },
  // 复合元音 11（含 ㅐㅔ 等；勿按严格语言学重划）
