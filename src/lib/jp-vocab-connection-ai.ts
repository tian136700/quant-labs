...
export const JP_VOCAB_CONNECTION_UPLOAD_SPEC = {
  ...
  rules: [
    ...
    "标准：每段公式后用全角「｜」加短「说明」列（该形态接上后表示什么），如「动词た形＋かもしれない｜推测已经发生的事」；说明宜短，禁止写恩惠流向／主语是谁等长用法；说明内勿用「／」（与形态分隔冲突），改用「、」或「·」",
...
- ✅ 标准：每段「词类／形态＋本语法｜短说明」（卡片三列：词类／形态、＋接什么、说明），如「动词た形＋かもしれない｜推测已经发生的事」。
