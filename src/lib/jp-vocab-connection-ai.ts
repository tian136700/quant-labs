...
export const JP_VOCAB_CONNECTION_UPLOAD_SPEC = {
  ...
  rules: [
    ...
    "标准：每段公式后用全角「｜」加短「说明」列，写清「该形态」差别（时间／肯定否定／词类义／句法角色），标本 id=521：辞书形｜推测将要发生或一般可能、た形｜推测已经发生的事；❌禁止多段都抄同一句用法大意（如每行「好像……、看起来……」）；说明宜短；说明内勿用「／」，改用「、」或「·」",
...
- ✅ 卡片三列「词类／形态｜＋接什么｜说明」：写成「词类／形态＋本语法｜短说明；…」（全角「；」），或分行「词类：说明」。❌禁止散文「接在动词、形容词、名词后面」。
- ✅ 多种动词形态都能接时：写成「动词辞书形（动词原形）＋X；动词た形＋X；动词ている形＋X」（每段都带「＋」）。❌不要「动词原形／动词た形／动词ている形＋X」只在末尾加一次「＋」。
- ✅ 标准：每段「词类／形态＋本语法｜短说明」（卡片三列），说明须区分该形态（标本 id=521：辞书形｜将要/一般、た形｜已经发生）；❌禁止多段都写同一句用法大意。
...
- ✅ 卡片三列「词类／形态｜＋接什么｜说明」：同一用法多种词类 →「词类／形态＋本语法｜短说明；…」；或分行「词类：说明」。❌禁止散文罗列词类。
