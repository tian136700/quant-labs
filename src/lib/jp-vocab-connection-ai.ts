...
export const JP_VOCAB_CONNECTION_UPLOAD_SPEC = {
  ...
  rules: [
    ...
    "对学生友好：能写「原形＋本语法」就写「原形」，少用「普通形」「现在肯定为词干」等术语",
...
- ✅ 对学生友好：能写「原形＋本语法」就写「原形」，少用「普通形」「现在肯定为词干」；な形容词／名词特殊时用短句（如「不加だ」「加だ」）。
...
- ✅ 对学生友好：能写「原形＋本语法」就写「原形」，少用「普通形」「现在肯定为词干」；な／名词特殊时短句说清（不加だ／加だ）。
- 若仍写「动词辞书形」必须写成「动词辞书形（动词原形）」；日语形态用「」短引；不要假名括注。
