...
export const JP_VOCAB_CONNECTION_UPLOAD_SPEC = {
  ...
  rules: [
    ...
    "对学生友好：写清词类，如「动词原形／一类形容词原形／二类形容词词干／名词＋本语法」；❌ 禁止只写笼统的「原形＋…」",
...
- ✅ 对学生友好：写清词类：动词原形／一类形容词原形／二类形容词词干／名词＋本语法；❌禁止只写笼统「原形＋…」；少用「普通形」「现在肯定为词干」；な形容词／名词特殊时用短句（如「不加だ」「加だ」）。
...
- ✅ 对学生友好：写清词类：动词原形／一类形容词原形／二类形容词词干／名词＋本语法；❌禁止只写笼统「原形＋…」；少用「普通形」「现在肯定为词干」；な／名词特殊时短句说清（不加だ／加だ）。
- 若仍写「动词辞书形」必须写成「动词辞书形（动词原形）」；日语形态用「」短引；不要假名括注。
