...
export const JP_VOCAB_USAGE_UPLOAD_SPEC = {
  ...
  rules: [
    ...
    "❌ 列举/并列（～し／～たり 等）禁止写「由多方面因素共同导致」「共同导致」等过强因果；可写「列举理由/情况」「又…又…」；后文「常接感想/结论」可以，勿写成语法本身=导致",
    ...
    "例句须场景自洽、有头有尾：前提与后半结果/建议自然衔接；禁止无厘头硬凑（❌来るなら、どうぞ入ってください／来的话请进；✅雨なら、傘を持っていってください）",
...
- 例句须场景自洽、有头有尾：条件/前提与后半结果或建议能自然连上，像一整句日常对话；禁止无厘头硬凑。
  - ❌「来(く)るなら、どうぞ入(はい)ってください。」／译文「来的话请进」（缺语境）
  - ✅「雨(あめ)なら、傘(かさ)を持(も)っていってください。」／译文「要是下雨的话，请把伞带去。」
- ❌ 禁止在例句日语行写中文教学说明（如「一类动词て形变形时…」）；规则只写用法或【接序】，例句须完整日语句。
