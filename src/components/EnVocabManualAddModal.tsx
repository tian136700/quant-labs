...
type Props = {
  ...
  locale: "en" | "zh";
  onClose: () => void;
  onAdded: (word: EnVocabWord, ref?: EnVocabRef, refDeduped?: boolean) => void;
};
...
export function EnVocabManualAddModal({
  open,
  locale,
  onClose,
  onAdded,
  ...
  const submit = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/en-vocab/add", {
        method: "POST",
      ...
      const ref: EnVocabRef | undefined =
        data.ref_key != null
          ? {
