...
import { lessonTeacherSubjectLabel } from "@/lib/lesson-teacher-subject";
import {
...
export type AdminJpLessonTeachersAddModalProps = {
  ...
  onAddSubjectChange?: (s: LessonTeacherSubject) => void;
};
          ...
          {showSubjectSelect ? (
            <label className="admin-user-add-field">
              ...
              <select
                ...
                onChange={(e) =>
                  onAddSubjectChange?.(e.target.value as LessonTeacherSubject)
                }
              >
                <option value="jp">{lessonTeacherSubjectLabel("jp", locale)}</option>
                <option value="en">{lessonTeacherSubjectLabel("en", locale)}</option>
                <option value="ko">{lessonTeacherSubjectLabel("ko", locale)}</option>
              </select>
            </label>
          ) : null}
          <label className="admin-user-add-field">
