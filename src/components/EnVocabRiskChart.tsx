...
import { buildRiskChartData, countExcludedRiskRows, type EnVocabRiskRow } from "@/lib/en-vocab-risk";
...
function RiskTooltip({
  ...
  active?: boolean;
  payload?: { payload: EnVocabRiskRow }[];
}) {
...
export function EnVocabRiskChart({ words }: Props) {
