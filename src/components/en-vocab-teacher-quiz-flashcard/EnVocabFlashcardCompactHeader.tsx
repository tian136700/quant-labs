...
export function EnVocabFlashcardCompactHeader(props: Props) {
  const {
    isStudy, previewMode, session, locale, dailySeq, progressLabel, remainingLabel,
    ...
    isStudy: boolean; previewMode: boolean; session: import("@/lib/en-vocab-teacher-quiz").EnVocabTeacherQuizSession | null;
    locale: "zh" | "en"; dailySeq: number | null | undefined; progressLabel: string; remainingLabel: string;
    sessionComplete: boolean; showAnswerTimer: boolean; answerTimerArmed: boolean;
    selected: import("@/lib/types").EnVocabLevel | undefined; answerElapsedSec: number; onClose: () => void;
    sessionChecked: number; sessionTotal: number; uncheckedCount: number; sessionPct: number; studentPeeked: boolean;
  };
  return (
