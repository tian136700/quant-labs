...
const MOCK_WORD_571: JpVocabWord = {
  ...
  connection: [
    "用法1: 名词＋だ＋と思います｜表示说话人的意见或想法",
    "用法2: 动词辞書形（动词原形）＋と思います｜推测将发生一般情况",
    "用法3: 动词た形＋と思います｜推测已经发生的事",
    "用法4: 二类形容词＋だ／一类形容词普通形＋と思います｜推测性质或状态",
    "用法5: 动词ない形／动词なかった形＋と思います｜推测否定内容",
  ].join("\n"),
  connection_source: "Agent现写",
  example_sentences: [
    "彼(かれ)は先生(せんせい)だと思(おも)います。",
    "译文：我觉得他是老师。",
